      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 md:px-24 py-12">
        ...
        <section className="text-center mb-12 md:mb-16 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <Button size="lg" className="text-lg px-8 py-6 dark.bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 hover:scale-105 hover:shadow-2xl transition-all duration-300">
               <Link 
